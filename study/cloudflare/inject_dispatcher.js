...
(function(){
  ...
  fetch('/study/templates/'+tpl+'.html')
    ...
    .then(function(html){
      ...
      if(/와와/.test(kw)){var cm=html.match(/<section[^>]*id="consult"[^>]*>[\\s\\S]*?<\\/section>/);if(cm){var ch='<div id="wawa-hero"><style>#wawa-hero{background:#fff;padding:56px 20px 48px;text-align:center;border-bottom:1px solid #eee}#wawa-hero .c3-section{background:transparent!important;padding:0}#wawa-hero .c3-eyebrow{color:#999}#wawa-hero .c3-warn{color:#111}#wawa-hero .c3-wawa{color:#e53935}#wawa-hero .c3-bar{background:#e53935}#wawa-hero .c3-num{color:#e53935}#wawa-hero .c3-ring{border-color:#e53935}#wawa-hero .c3-sub{color:#555}#wawa-hero .c3-img{display:none}#wawa-ttl{font-size:26px;font-weight:800;color:#111;margin:0 0 20px;line-height:1.4}</style><p id="wawa-ttl">'+loc+' 와와학원</p>'+cm[0]+'</div>';html=html.replace(/<body[^>]*>/,function(m){return m+ch;});}}
